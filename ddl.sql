...
CREATE TABLE UTILISATEUR (
  ...
  EMAIL       VARCHAR(200),
  MDP		VARCHAR(200),
  ID_ENTREPRISE	BIGINT DEFAULT '101',
  TELEPHONE       VARCHAR(200),
  CREATION     TIMESTAMP NOT NULL DEFAULT now(),
  MAJ     TIMESTAMP NOT NULL DEFAULT now(),
  CONSTRAINT telephone_unique UNIQUE (TELEPHONE),
...
CREATE TABLE ENTREPRISE (
  ...
  CONSTRAINT e_pk PRIMARY KEY (ID),
  CONSTRAINT e_ad_fk FOREIGN KEY (ID_ADRESSE) REFERENCES ADRESSE (ID),
  CONSTRAINT e_us_fk FOREIGN KEY (ID_UTILISATEUR) REFERENCES UTILISATEUR (ID)
) AUTO_INCREMENT  = 100;
...
INSERT INTO `entreprise` (`ID`, `NOM`, `ID_ADRESSE`, `ID_UTILISATEUR`, `CREATION`, `MAJ`) VALUES (NULL, 'Solutec', '100', '100', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), (NULL, 'Solutec Lyon', '101', '100', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), (NULL, 'Miam', '102', '101', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO `evenement` (`ID`, `NOM`, `QUANTIEME`, `STATUT`, `CREATION`, `MAJ`, `ID_ADRESSE`) VALUES (NULL, 'evenement1', '2019-01-31 00:00:00', '1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '100'), (NULL, 'evenement2', '2019-02-01 00:00:00', '0', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '101'), (NULL, 'evenement3', '2019-02-03 00:00:00', '0', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '102'); 

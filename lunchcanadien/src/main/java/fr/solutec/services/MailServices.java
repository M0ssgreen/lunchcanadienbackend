...
public class MailServices {
	 ...
	 public void envMailOrganisateur(User user, Event event) {
		 ...
		 String Newligne=System.getProperty("line.separator");
		 String contenu = "Bonjour " + user.getPrenom() + "," + Newligne + Newligne + "Un événement a matché." + Newligne + "Veuillez vous rendre sur le lunch pour choisir le lieu de rencontre: http://localhost/lunchcanadienfrontend/choixresto.html?id="+ event.getId() + Newligne + Newligne + "Bonne journée !" + Newligne + "Equipe LunchCanadien";
